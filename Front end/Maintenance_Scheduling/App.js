...
import VehicleMain from './screens/VehicleMain';
...
export default function App() {
  ...
  //       fetch('http://192.168.1.109:8080/vehicle/maintenance-details', { 
  //       method: 'POST',
  //       headers: {
  //           'Content-Type': 'application/json',
  //       },
  ...
  //   fetch('http://192.168.1.109:8080/vehicle/current-Mileage', {
  //     method: 'POST',
  //     headers: {
  //       'Content-Type': 'application/json',
  //     },
